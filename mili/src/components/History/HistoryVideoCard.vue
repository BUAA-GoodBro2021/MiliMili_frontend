  ...
  <div>
    <div class="card_wrap">
      <!-- <router-link :to="'/videodetail/' + video.id"  style="text-decoration: none;"> -->
        <div class="card_img"  @click="toVideo()">
      ...
      <div class="card_body">
        ...
        <div class="card_footer">
          <ul>
            <li>
              <i class="el-icon-video-play text_icon" /><span
                class="text_footer"
              >
                {{ video.view_num }}</span
              >
            ...
            <li>
              <i class="el-icon-thumb text_icon" /><span class="text_footer">
                {{ video.like_num }}</span
              >
            </li>
            <li>
              <i class="el-icon-star-off text_icon" /><span class="text_footer">
