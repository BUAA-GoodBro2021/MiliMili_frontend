        ...
        <div class="blocks">
          ...
          <div class="block_others">
            ...
            <div class="card c2" >
              ...
              >
                <i class="el-icon-user iconImg t2" /><span class="text t2">
                  个人信息</span
                >
              </router-link>
            </div>
            <div class="card c3" >
              <router-link to="/PCmanageVideo" style="text-decoration: none">
                <i class="el-icon-document iconImg t3" /><span class="text t3">
                  稿件管理</span
                >
              </router-link>
            </div>
            ...
            <div class="card c4" >
              <router-link to="/history" style="text-decoration: none">
                <i class="el-icon-folder-opened iconImg t4" /><span
                  class="text t4"
                >
                  观看历史</span
                >
...
.c4 {
  /* background-color:  rgba(230, 180, 80, 0.717); */
